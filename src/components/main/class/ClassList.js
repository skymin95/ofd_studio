  ...
  return (
    <>
      ...
      <article className='list_cont'>
        ...
        <ClassConts cartAdd={cartAdd} setcartAdd={setcartAdd} cartList={cartList} setcartList={setcartList} userInfo={userInfo} memberclasslist={memberclasslist} select={select} sortDate2={sortDate2} sortByLowPrice={sortByLowPrice} sortInst={sortInst} sortLev={sortLev} sortKind={sortKind} />
      </article>
    </>
  );
}
